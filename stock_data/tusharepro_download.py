...
class TUShareDownload(object):
    ...
    def dump_K_start_end_tongyonghangqing(self, ts_code='', start_date='', end_date='', freq='D', asset='E', adj=None, retry_count=3):
        ts_code_dir = os.path.join(self.data_dir, ts_code)
        ts_code_year_dir = os.path.join(ts_code_dir, str(start_date)[0:4])
        if not os.path.exists(ts_code_year_dir):
            os.makedirs(ts_code_year_dir)
    ...
    def dump_zijinliuxiang(self, api_name='moneyflow_hsgt', trade_date=None, start_date='20200101', end_date='20201231'):
    ...
    def dump_hushenshidachengjiaogu(self, ts_code='', start_date='20200101', end_date='20201231'):
